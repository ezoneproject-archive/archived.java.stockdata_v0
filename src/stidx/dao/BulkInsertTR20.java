...
import stidx.tables.TR20;

public class BulkInsertTR20 extends HibernateDaoSupport implements
        BulkInsertModule {
    Logger log = LogManager.getLogger(BulkInsertTR20.class);
    ...
    public void insertOrUpdate(TR20 investTrans) {
        getHibernateTemplate().saveOrUpdate(investTrans);
    }

    public void delete(TR20 investTrans) {
