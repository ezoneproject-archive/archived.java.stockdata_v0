...
import stidx.tables.ForeignTrans;
import stidx.tables.StockCode;

public class BulkInsertForeign extends HibernateDaoSupport implements BulkInsertModule {
    Logger log = LogManager.getLogger(BulkInsertForeign.class);
    ...
    public void insertBulkRaw(String date, String time, String data) throws Exception {
        ...
        ForeignTrans tr = new ForeignTrans();
        tr.setGsDate(date);
        tr.setGsTime(time);
    ...
    public void insertOrUpdate(ForeignTrans foreignTrans) {
        getHibernateTemplate().saveOrUpdate(foreignTrans);
    }

    public void delete(ForeignTrans foreignTrans) {
        getHibernateTemplate().delete(foreignTrans);
    }
