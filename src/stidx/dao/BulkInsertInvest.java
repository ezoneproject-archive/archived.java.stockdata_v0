...
public class BulkInsertInvest extends HibernateDaoSupport implements
        BulkInsertModule {
    Logger log = LogManager.getLogger(BulkInsertInvest.class);
    ...
    public void insertBulkRaw(String date, String time, String data)
        ...
        InvestTrans tr = new InvestTrans();
        tr.setGsDate(date);
        tr.setGsTime(time);
    ...
    public void insertOrUpdate(InvestTrans investTrans) {
        getHibernateTemplate().saveOrUpdate(investTrans);
    }

    public void delete(InvestTrans investTrans) {
